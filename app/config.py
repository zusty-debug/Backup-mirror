...
class Settings(BaseSettings):
    ...
    status_update_seconds: int = Field(default=2, alias="STATUS_UPDATE_SECONDS", ge=1, le=60)
    initial_sends_per_minute: int = Field(default=40, alias="INITIAL_SENDS_PER_MINUTE", ge=10, le=100)
    max_sends_per_minute: int = Field(default=100, alias="MAX_SENDS_PER_MINUTE", ge=10, le=600)
    pace_upgrade_after_messages: int = Field(default=100, alias="PACE_UPGRADE_AFTER_MESSAGES", ge=10, le=1000)
